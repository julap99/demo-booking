    ...
    >
      <div class="max-w-4xl mx-auto py-6 sm:py-12 px-4 sm:px-6 lg:px-8">
        ...
        >
          <!-- Header with Steps -->
          <div
            class="relative bg-white px-4 sm:px-8 py-8 border-b border-[#3C2A21]/10"
          >
            <h1
              class="text-xl sm:text-2xl font-semibold text-[#3C2A21] text-center mb-10 font-playfair"
            >
              Book Your Session
            </h1>
              ...
              <div class="relative flex items-center justify-between">
                ...
                <template v-for="(step, index) in steps" :key="step.number">
                  <div class="relative flex flex-col items-center">
                    ...
                    <!-- Step Label -->
                    <div
                      class="absolute -bottom-8 left-1/2 -translate-x-1/2 w-max"
                    >
                      <span
                        class="text-xs sm:text-sm font-medium whitespace-nowrap font-playfair"
                        :class="
                          currentStep >= step.number
                            ? 'text-[#3C2A21]'
                            : 'text-[#3C2A21]/60'
            ...
            <TransitionGroup name="fade">
              ...
              <div v-show="currentStep === 1" key="step1" class="space-y-8">
                <div class="max-w-lg mx-auto">
                  <h2
                    class="text-lg sm:text-xl font-semibold text-[#3C2A21] mb-6 font-playfair"
                  >
                  ...
                  <div class="space-y-6">
                    ...
                    <div class="form-group">
                      <textarea
                        ...
                        rows="3"
                        class="form-input peer min-h-[100px]"
                    ...
                    <div class="space-y-4 pt-4">
                      <div class="flex items-start">
                        ...
                        <div class="ml-3">
                          <label
                            for="terms"
                            class="text-sm text-[#3C2A21] font-playfair"
                          >
                            I agree to the
                            <button
                              type="button"
              ...
              <div v-show="currentStep === 2" key="step2" class="space-y-8">
                <div class="max-w-2xl mx-auto">
                  <h2
                    class="text-lg sm:text-xl font-semibold text-gray-900 mb-6 font-playfair"
                  >
                    Choose your theme
                  </h2>
                  ...
                  <div class="grid sm:grid-cols-2 gap-6">
                    ...
                    >
                      ...
                      <div
                        :class="[
                          'p-6 rounded-2xl transition-all duration-300 cursor-pointer bg-white min-h-[400px] flex flex-col',
                      ...
                      >
                        <!-- Image Placeholder -->
                        <div
                          class="w-full aspect-[4/3] bg-[#F5E6E0] rounded-xl mb-4 flex-shrink-0"
                        ></div>
                        ...
                        <div class="space-y-3 flex-grow flex flex-col">
                          ...
                          <div>
                            <h3
                              class="text-xl font-semibold text-[#3C2A21] font-playfair mb-1"
                            >
                              {{ type.label }}
                            </h3>
                          ...
                          <!-- Footer -->
                          <div
                            class="pt-3 border-t border-[#3C2A21]/10 mt-auto"
                          >
                            <div class="flex items-center justify-between">
                              <div>
                                <p class="text-sm text-[#3C2A21]/70">Price</p>
                                <p class="text-xl font-semibold text-[#3C2A21]">
              ...
              <!-- Step 3: Session (Select Date & Time) -->
              <div v-show="currentStep === 3" key="step3" class="space-y-8">
                <div class="max-w-2xl mx-auto">
                  ...
                  <!-- Custom Date Picker -->
                  <div class="bg-[#F5E6E0] rounded-2xl p-6 mt-6">
                    <h3
                      class="text-base font-medium text-gray-900 mb-4 font-playfair"
                    >
                      Select Date & Time
                    </h3>
                    ...
                    <div v-if="formData.date">
                      <h4
                        class="text-sm font-medium text-gray-700 mb-3 font-playfair"
                      >
              ...
              <div v-show="currentStep === 4" key="step4" class="space-y-8">
                <div class="max-w-lg mx-auto">
                  ...
                  <!-- Session Summary -->
                  <div class="bg-[#F5E6E0] rounded-2xl p-6 mb-8">
                    <h3
                    ...
                    <div class="space-y-4">
                      ...
                      <div class="pt-4 mt-4 border-t border-[#3C2A21]/10">
                        <div class="space-y-2">
                          <div
                          ...
                          <div class="flex justify-between items-center">
                            <span class="text-base font-medium text-[#3C2A21]"
                              >Deposit Amount (Required)</span
                            >
                            <span
                              class="text-lg font-semibold text-[#3C2A21]"
                              >{{ depositAmount }}</span
                            >
                          </div>
                  ...
                  <div class="space-y-6">
                    ...
                    <!-- Online Banking -->
                    <div
                      class="p-4 rounded-xl border-2 border-[#3C2A21] bg-[#3C2A21]/5 cursor-pointer"
                    >
                      <div class="flex items-center">
                        ...
                        <div>
                          ...
                          <p class="text-sm text-[#3C2A21]/70 mt-1">
                    ...
                    >
                      <div class="flex items-center">
                        ...
                        ></div>
                        <div>
                          <h4 class="text-base font-medium text-gray-400">
                            Credit / Debit Card
                          </h4>
          ...
          <!-- Navigation Footer -->
          <div
            class="px-4 sm:px-8 py-6 bg-gradient-to-br from-[#F5E6E0] via-[#E6CCB2] to-[#DDB892] flex justify-between items-center"
          >
            <button
              v-if="currentStep > 1"
              @click="currentStep--"
            ...
            <NuxtLink v-else to="/" class="btn btn-secondary">
              <svg
                class="w-4 h-4 mr-2"
                fill="none"
                stroke="currentColor"
            ...
            <button
              ...
              class="py-3 px-4 border border-transparent rounded-lg text-sm font-medium text-white bg-gradient-to-r from-[#3C2A21] to-[#5C4033] hover:from-[#5C4033] hover:to-[#7B5544] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#3C2A21] transition-all duration-200 transform hover:scale-[1.02]"
            >
      ...
      <Transition name="modal">
        ...
        >
          ...
          <div class="flex min-h-screen items-center justify-center p-4">
            <!-- Modal panel -->
            <div
              class="relative transform overflow-hidden rounded-2xl bg-white shadow-xl transition-all w-full max-w-2xl"
            >
              <!-- Header -->
              <div
                class="border-b border-[#3C2A21]/10 px-6 py-4 flex items-center justify-between"
              >
                <h3
                  class="text-lg font-semibold text-[#3C2A21]"
                  id="modal-title"
              ...
              <div class="px-6 py-4 max-h-[60vh] overflow-y-auto">
                <div class="space-y-6 text-[#3C2A21]">
                  <!-- Booking & Payment -->
                  <section>
                    <h4 class="text-base font-semibold mb-3 font-playfair">
                      1. Booking & Payment
                    </h4>
              ...
              <!-- Footer -->
              <div
                class="border-t border-[#3C2A21]/10 px-6 py-4 flex justify-end"
              >
                <button
                  @click="showTerms = false"
                  class="px-4 py-2 text-sm font-medium text-white bg-[#3C2A21] rounded-lg hover:bg-[#5C4033] transition-colors"
                >
                  I Understand
                </button>
              </div>
...
.form-input {
  @apply block w-full px-4 pt-6 pb-2 text-[#3C2A21] bg-white border border-[#3C2A21]/20 rounded-xl appearance-none transition-all duration-200;
...
.form-label {
  @apply absolute left-4 top-4 text-[#3C2A21]/60 text-sm transition-all duration-200 cursor-text;

  .form-input:focus + &,
  .form-input:not(:placeholder-shown) + & {
    @apply transform -translate-y-3 scale-75 text-[#3C2A21];
  }
...
@media (max-width: 400px) {
  .form-input {
    @apply px-3 pt-5 pb-1.5 text-sm;
  }

  .form-label {
    @apply text-xs left-3;
  }
