<template>
  <div class="space-y-6">
          ...
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-2">
              ...
              <button
                ...
                class="p-1.5 text-[var(--color-text-muted)] hover:text-[var(--color-primary)] transition-colors duration-200"
                :title="addon.status === 1 ? 'Deactivate Add-on' : 'Activate Add-on'"
              >
                <svg
                  v-if="addon.status === 1"
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span class="sr-only">{{ addon.status === 1 ? 'Deactivate Add-on' : 'Activate Add-on' }}</span>
              </button>
              <button
    ...
    <TransitionRoot appear :show="showAddAddonModal" as="template">
      <Dialog as="div" @close="closeAddAddonModal" class="relative z-50">
        <TransitionChild
          as="template"
